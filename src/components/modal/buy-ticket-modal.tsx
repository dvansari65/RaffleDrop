      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-slate-900 rounded-2xl border border-red-900/50 overflow-hidden">
          ...
          <div className="p-6 border-b border-red-900/30">
            ...
            <p className="text-sm text-slate-400 font-mono mt-2">Enter number of tickets to purchase</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              <label className="text-sm font-mono text-slate-400 uppercase tracking-wider">Number of Tickets</label>
